...
public final class ProfileLimits {
  ...
  public static final String SUCCESS_MESSAGE = "Profile updated successfully";

  public static final String VALID_FULL = "MAXIMUS Petrov";
  ...
  public static final String ABOVE_MAX_LENGTH = "A".repeat(500) + " " + "B".repeat(205);
